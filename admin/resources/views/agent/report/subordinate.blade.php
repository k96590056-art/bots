...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">下级代理佣金报表</h1>
    <form class="form-inline ml-auto" action="{{url('/profit')}}" method="get">
        <div class="input-group">
            <input type="text" class="form-control bg-light border-0 small" placeholder="请选择开始时间" id="start1" name="start" value="{{$start}}">&nbsp;&nbsp;
            <input type="text" class="form-control bg-light border-0 small" placeholder="请选择结束时间" id="end1" name="end" value="{{$end}}">&nbsp;&nbsp;
            <input type="text" class="form-control bg-light border-0 small" name="username" placeholder="请输入用户名..." aria-label="Search" aria-describedby="basic-addon2" value="{{$username}}">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">下级代理佣金报表</h6>
    </div>
    <div class="card-body">
