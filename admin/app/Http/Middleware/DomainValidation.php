...
class DomainValidation
{
    ...
    {
        // Telegram Webhook 请求通常没有 Origin/Referer，需要特殊处理
        // 检查是否为 Telegram webhook 路由
        $isTelegramWebhook = $request->is('api/telegram/*') || 
                            strpos($request->path(), 'telegram') !== false;
        
        // 如果是 Telegram webhook，直接通过（Telegram 服务器没有 Origin/Referer）
